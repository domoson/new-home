...
export type Opening = { start: number; width: number; sill: number; height: number; kind: 'door' | 'window' | 'passage'; id: string; hinge?: 'end'; swing?: 'reverse'; frame?: number; cornerGlazing?: boolean; windowLayout?: { columns: 1 | 2; lowerFixed?: number } }
